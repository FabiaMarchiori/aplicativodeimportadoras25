  ...
  return (
    <header className="mb-4">
      <div className="flex flex-col items-center">
        <div className="mb-4">
          <Avatar className="w-24 h-24 border-2 border-[#3CBBC7]">
            <AvatarImage src={fornecedor.logo_url || ''} alt={fornecedor.nome} className="object-cover" />
            <AvatarFallback className="bg-[#3CBBC7]/10 text-[#3CBBC7]">{fornecedor.nome?.charAt(0)}</AvatarFallback>
          </Avatar>
        </div>
        <h1 className="text-2xl font-bold text-[#322523]">{fornecedor.nome_loja || fornecedor.nome}</h1>
