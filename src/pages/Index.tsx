...
const Index = () => {
  ...
  console.log('Index - Estado:', { user: !!user, loading });

  useEffect(() => {
    // Só redirecionar quando o loading terminar
    if (!loading) {
      console.log('Index - Redirecionando...', { user: !!user });
      if (user) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0F4C75] via-[#3AAFA9] to-[#5FB9C3]">
      <div className="text-center text-white">
        <div className="mx-auto mb-6 w-20 h-20 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm shadow-lg animate-pulse">
