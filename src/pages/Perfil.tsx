...
export default function Perfil() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1981A7] via-[#4A9DB8] to-[#5FB9C3] text-white relative overflow-hidden">
        ...
        <div className="space-y-4 mb-6">
          ...
          <ProfileInfoCard title="Configurações" icon={Settings}>
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full border-white/30 text-white hover:bg-white/10 hover:border-white/50 transition-all duration-200"
        ...
        <DialogContent className="bg-gradient-to-br from-[#1981A7] to-[#4A9DB8] text-white border-white/20 backdrop-blur-sm">
          ...
          <form onSubmit={handleChangePassword}>
            <div className="space-y-4 py-4">
              {error && (
                <div className="text-sm font-medium text-red-300 bg-red-500/20 p-3 rounded-lg border border-red-400/30">
                  {error}
                </div>
              )}
            ...
            <DialogFooter className="gap-2">
              ...
              <Button 
                type="submit" 
                disabled={isLoading} 
                className="bg-[#F9C820] hover:bg-[#F9C820]/90 text-[#1981A7] font-medium"
              >
                {isLoading ? (
                  <>
